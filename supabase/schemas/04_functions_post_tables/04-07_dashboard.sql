create function public.get_dashboard_metrics(
  ...
  contact_activity jsonb,
  message_activity jsonb,
  team_snapshot jsonb
)
language plpgsql
stable
...
comment on function public.get_dashboard_metrics(uuid, integer) is
'Returns organization-scoped contact, conversation, message, and human-team dashboard metrics for a 7- or 30-day UTC period.';
