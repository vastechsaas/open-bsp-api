...
revoke all on table public.platform_report_export_events from anon, authenticated;
revoke all on table public.platform_admin_action_events from anon, authenticated;
